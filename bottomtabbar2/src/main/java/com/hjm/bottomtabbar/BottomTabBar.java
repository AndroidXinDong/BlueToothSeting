...
//        fontImgPadding = px2designHeightPx(fontImgPadding);
     ...
     * @return
     */
    public BottomTabBar addTabItem(String name, int imgId, Class fragmentClass,Bundle bundle) {
        return addTabItem(name, ContextCompat.getDrawable(context, imgId), fragmentClass,bundle);
    }

    public BottomTabBar addTabItem(String name, int imgIdSelect, int imgIdUnSelect, Class fragmentClass,Bundle bundle) {
        return addTabItem(name, ContextCompat.getDrawable(context, imgIdSelect), ContextCompat.getDrawable(context, imgIdUnSelect), fragmentClass,bundle);
    }
     ...
     * @return
     */
    public BottomTabBar addTabItem(String name, Drawable drawable, Class fragmentClass, Bundle bundle) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec(TextUtils.isEmpty(name) ? fragmentClass.getName() : name)
                .setIndicator(getTabItemView(TextUtils.isEmpty(name) ? fragmentClass.getName() : name, drawable, null)), fragmentClass, bundle);
        return this;
    }

    public BottomTabBar addTabItem(String name, Drawable drawableSelect, Drawable drawableUnSelect, Class fragmentClass,Bundle bundle) {
        tabIdList.add(TextUtils.isEmpty(name) ? fragmentClass.getName() : name);
        mTabHost.addTab(mTabHost.newTabSpec(TextUtils.isEmpty(name) ? fragmentClass.getName() : name)
                .setIndicator(getTabItemView(TextUtils.isEmpty(name) ? fragmentClass.getName() : name, drawableSelect, drawableUnSelect)), fragmentClass, bundle);
        return this;
    }
    /*=====================核心功能 End=============================*/
